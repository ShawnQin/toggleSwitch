% =========================================================================
% this grogram summary data of mutual activation model modeled CLE
% and plot the EWS
% =========================================================================

clear
clc
DataFolder = '/home/shan/Documents/MATLAB/criticlity/toggleSwitch/mutualActi';
...
pattern1 = '_tau-10_se[0-9\._]+N500';
...
for i0 = 1:length(AllFile_amplitude)
    ...
    SummaryAmpli.a1 = [SummaryAmpli.a1,tempData.k1list'];
...
Folder1 = '/home/shan/Documents/MATLAB/criticlity/toggleSwitch/mutualActi';
filenameAmpLNA = [Folder1, filesep,'MutualActiLNATheoryAmpl_N500.mat'];
...
for i0 = 1:3;
    ...
    plot(AmpLNA.k1,AmpLNA.varB(:,inx_se(i0)),'LineWidth',LineWidth,'Color',colorSet(i0,:))
end
plot(AmpLNA.k1,AmpLNA.var0B,'-','Color',colorSet(4,:),'LineWidth',LineWidth)
hold off
axis([0.1,0.6,100,1e5])
set(gca,'Xtick',3:2:16,'YScale','log','LineWidth',ticketWidth,'FontName','Helvetica','FontSize',axisFontSize)
...
for i0 = 1:length(inx_se)
    ...
    plot(AmpLNA.k1,cvB(:,i0),'LineWidth',LineWidth,'Color',colorSet(i0,:))
...
for i0 = 1:length(inx_se)
    ...
    plot(AmpLNA.k1,FanoB(:,i0),'LineWidth',LineWidth,'Color',colorSet(i0,:))
...
plot(AmpLNA.k1,Fano0B,'k-','LineWidth',LineWidth,'Color',colorSet(4,:))
hold off
axis([0.05,0.6,0.5,100])
set(gca,'Xtick',0.1:0.1:0.6,'YScale','log','LineWidth',ticketWidth,'FontName','Helvetica','FontSize',axisFontSize)
xlabel('a1','FontSize',labelFontSize,'FontName','Helvetica')
...
for i0 = 1:length(inx_se);
    ...
    'MarkerFaceColor','auto');
    plot(AmpLNA.k1,AmpLNA.corr(:,inx_se(i0)),'LineWidth',LineWidth,'Color',colorSet(i0,:))
end
plot(AmpLNA.k1,AmpLNA.corr0,'k-','LineWidth',LineWidth,'Color',colorSet(4,:))
hold off
axis([0.05,0.6,0,1])
set(gca,'Xtick',0.1:0.1:0.6,'Ytick',0:0.2:1,'LineWidth',ticketWidth,'FontName','Helvetica','FontSize',axisFontSize)
xlabel('a1','FontSize',labelFontSize,'FontName','Helvetica')
...
for i0 = 1:length(inx_se);
    errorbar(SummaryAmpli.a1(:,i0), SummaryAmpli.lagAuto2(:,i0),SummaryAmpli.lagAuto2_std(:,i0),...
        'o','MarkerSize',errorMarkerSize,'Color',colorSet(i0,:),'LineWidth',errorBarSize);
    plot(AmpLNA.k1,AmpLNA.lagB(:,inx_se(i0)),'LineWidth',LineWidth,'Color',colorSet(i0,:))
end
plot(AmpLNA.k1,AmpLNA.lag0B,'k-','LineWidth',LineWidth,'Color',colorSet(4,:))
hold off
axis([0,0.6,0.3,1.05])
set(gca,'Xtick',0:0.1:0.6,'LineWidth',ticketWidth,'FontName','Helvetica','FontSize',axisFontSize)
xlabel('a1','FontSize',labelFontSize,'FontName','Helvetica')
